...
let item = document.querySelectorAll('.item__treatment');
const itemLength = item.length;
// console.log(itemLength);

const rightArrow = document.querySelector("#rightArrow__treatment");
const leftArrow = document.querySelector("#leftArrow__treatment");
let slider = [];
